...
class MovieLoadStateAdapter(private val retry: () -> Unit) : LoadStateAdapter<MovieLoadStateAdapter.ViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        loadState: LoadState
    ): MovieLoadStateAdapter.ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = inflater.inflate(R.layout.load_state_footer, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: MovieLoadStateAdapter.ViewHolder, loadState: LoadState) {
